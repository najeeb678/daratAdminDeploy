...
const CustomPagination: React.FC<CustomPaginationProps> = ({
   ...
   return (
      ...
      >
         ...
         <Box display="flex" alignItems="center" justifyContent="flext-end">
            <Box
            ...
            >
               <ArrowBackIosRoundedIcon sx={{ width: '15px', height: '15px', color: "white" }} />
            </Box>
            ...
            {pagesToShow.map((pageItem, index) => (
               <Box
                  ...
                  onClick={(event) => {
                     if (pageItem !== '...') {
                        onPageChange(event as React.MouseEvent<HTMLElement, MouseEvent>, pageItem as number);
                     }
                  }}
                  sx={{
                     width: "37px",
            ...
            >
               <ArrowForwardIosRoundedIcon sx={{ width: '15px', height: '15px', color: "white" }} />
            </Box>
         </Box>
      </Box>
   );
